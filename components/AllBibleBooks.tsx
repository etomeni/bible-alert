...
export default function AllBibleBooks(
    {allBibleBooks, settings, searching, selectedBibleBookRedux, onSelectBook}
    :
    {
        allBibleBooks: _bibleBookSelection_[], 
    ...
    return (
        <ScrollView>
            <View style={styles.container}>
                {
                    allBibleBooks.length && searching == false ? (
